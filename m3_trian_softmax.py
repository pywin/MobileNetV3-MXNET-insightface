...
def parse_args():
  ...
  parser.add_argument('--loss-type', type=int, default=0, help='loss type')
...
def get_symbol(args, arg_params, aux_params):
  ...
  if args.network[0]=='d':
    ...
    print('init mobilenetv3', args.num_layers)
    embedding = fmobilenetv3.get_symbol(num_classes=args.emb_size, mode='large', fc_type=args.version_output)
